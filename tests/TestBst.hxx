...
{
  return Grove::GenerateBinarySearchTree({1, 2, 3, 4, 5, 6, 7}).get() != nullptr;
}

bool TestGenerateBinarySearchTree2()
{
  return Grove::IsBinarySearchTree(Grove::GenerateBinarySearchTree(Grove::GenerateBinaryTree({1, 2, 3, 4, 5, 6, 7})));
}
